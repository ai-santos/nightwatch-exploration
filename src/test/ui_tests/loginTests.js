...
module.exports = {
  'Login Page Initial Render': function(browser) {
    browser
      .url('https://qa-smp.qa.eginternal.com') //decouple this into its own command from a utility file
      .assert.urlContains('login')
      .waitForElementVisible('body', 1000)
      .assert.title('Endgame')
      .assert.containsText('div.endgame-logo', 'ENDGAME.')
      .assert.elementPresent('input[name="endgameUsername"]')
      .assert.elementPresent('input[name="endgamePassword"]')
      .assert.elementPresent('div.footer')
      .assert.containsText('div.links a span', 'About Endgame')
  ...
  'Login Takes Admin User To Dashboard': function(browser) {
    browser
      ...
      .setValue('input[name="endgamePassword"]', 'smp+3ndg@m3')
      .click('button[type=submit]')
      .pause(1000)
      .url('https://qa-smp.qa.eginternal.com/dashboard')
      .waitForElementVisible('body', 1000)
  ...
  'Dashboard Page Initial Render': function(browser) {
    browser
      ...
      .assert.elementPresent('a[title~=dashboard]')
      .assert.elementPresent('a[title~=endpoints]')
      .assert.elementPresent('a[title~=alerts]')
  ...
  'Dashboard Page Link - Endpoints Work': function(browser) {
    browser
      ...
      .pause(1000)
      .url('https://qa-smp.qa.eginternal.com/endpoints')
      .waitForElementVisible('body', 1000)
  ...
  'Dashboard Page Link - Alerts Work': function(browser) {
    browser
      ...
      .pause(1000)
      .url('https://qa-smp.qa.eginternal.com/alerts')
      .waitForElementVisible('body', 1000)
  ...
  'Dashboard Page Link - Investigations Work': function(browser) {
    browser
      ...
      .pause(1000)
      .url('https://qa-smp.qa.eginternal.com/investigations')
      .waitForElementVisible('body', 1000)
