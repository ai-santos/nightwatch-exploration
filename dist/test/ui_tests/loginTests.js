...
module.exports = {
  ...
  'Dashboard Page Link - Administration Works': function DashboardPageLinkAdministrationWorks(browser) {
    browser.click('a[title~=administration]').pause(1000).url('https://qa-smp.qa.eginternal.com/administration').waitForElementVisible('body', 1000).assert.urlEquals('https://qa-smp.qa.eginternal.com/administration');
  }
};